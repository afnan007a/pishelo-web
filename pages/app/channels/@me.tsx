            ...
            <div className={`h-full flex min-h-screen w-full`}>
                ...
                <div className={`w-full h-full min-h-screen flex flex-col justify-center items-center text-center pt-12 pb-24 sm:pl-64`}>
                    <div>
                        ...
                        <h3 className={`text-3xl mt-1 font-semibold`}>Pishelo</h3>
                    </div>
                    ...
                    <div className={`grid px-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-3 md:gap-x-5 gap-y-3 mt-8 text-left`}>
                        <div className={`bg-[#21252B] rounded-xl max-w-[400px] w-fit flex items-center px-3 py-2`}>
                            <CompassOutline
                            ...
                            />
                            <div className={`ml-3`}>
                                <h1 className={`text-lg font-semibold`}>Discover Pishelo</h1>
                        ...
                        <div className={`bg-[#21252B] rounded-xl max-w-[400px] w-fit flex items-center px-3 py-2`}>
                            ...
                            />
                            <div className={`ml-3`}>
                                <h1 className={`text-lg font-semibold`}>Create a personal or public community</h1>
                        ...
                        <div className={`bg-[#21252B] rounded-xl max-w-[400px] w-fit flex items-center px-3 py-2`}>
                            ...
                            />
                            <div className={`ml-3`}>
                                <h1 className={`text-lg font-semibold`}>Join the Pishelo Testers Server</h1>
                        ...
                        <div className={`bg-[#21252B] rounded-xl max-w-[400px] w-fit flex items-center px-3 py-2`}>
                            ...
                            />
                            <div className={`ml-3`}>
                                <h1 className={`text-lg font-semibold`}>Donate to Pishelo</h1>
                                <h1 className={`text-[13px] mt-1 text-gray-400`}>Support the ongoing development project by donating - thank you!</h1>
                            </div>
                        </div>

                        <div className={`bg-[#21252B] rounded-xl max-w-[400px] w-fit flex items-center px-3 py-3`}>
                            <CogOutline
                                cssClasses={`fill-gray-300 text-gray-300`}
                                width={`40px`}
                                height={`40px`}
                            />
                            <div className={`ml-3`}>
                                <h1 className={`text-lg font-semibold`}>Manage Pishelo</h1>
